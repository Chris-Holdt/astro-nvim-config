...
CursorColumn = {bg = "#61508B"},
CursorLine = {bg = "#61508B"},
...
Label = {},
LineNr = {fg = "#A08573"},
MatchParen = {fg = "#FF576D", bg = "#9EED73"},
NonText = {fg = "#426BFF"},
...
TermCursor = {fg = "#2D2541", bg = "#9EED73"},
Todo = {fg = "#4B5558", bg = "#F5A742"},
Type = {fg = "#8AEFFF"},
VertSplit = {fg = "#8AEFFF", bg = "#8AEFFF"},
Visual = {fg = "#F5A742", bg = "#61508B"},
